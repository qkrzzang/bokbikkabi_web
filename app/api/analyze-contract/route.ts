...
**B. 일반임대차계약서 (GENERAL)**
* 문서 제목이 '부동산임대차계약서', '아파트 전세계약서', '다세대/연립/빌라 월세 계약서' 등 다양한 형태인 경우.
* 특징: 공인중개사 정보가 문서 맨 하단에 위치함.

**C. 계약서 아님 (NON_CONTRACT)**
* 부동산 계약 관련 핵심 키워드나 양식이 아닌 경우.
...
반드시 '2. 공인중개사' 또는 '2. 개업공인중개사' 라벨 이후에 등장하는 값을 탐색하세요.
'1. 계약 당사자' 섹션의 정보(임대인/임대사업자)는 무시합니다.
...
패턴 특징: 보통 92300000-03945처럼 8~10자리 연속 숫자이거나, 시군구 코드가 포함된 숫자로 구성됩니다.
