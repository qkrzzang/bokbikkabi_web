      ...
      <div className={styles.content}>
        ...
        <section className={styles.section}>
          ...
          <ul>
            ...
            <li>
              <strong>데이터 보안 관리</strong>: 회사는 이용자의 개인정보 보호를 위해 계약서 이미지 분석 시
              중개사 정보(상호, 등록번호, 소재지 등) 영역만을 절취(Crop)하고, 그 외 개인 식별 정보가
              포함된 영역은 즉시 파기합니다. <strong>절취된 중개사 정보는 암호화하여 안전하게
              관리하며,</strong> 이는 리뷰의 실거래 여부 확인 및 서비스 운영 목적으로만 활용됩니다.
            </li>
          </ul>
        </section>
