...
for (let i = 0; i < lines.length; i++) {
  if (lines[i].includes('const handleCancelConfirm = () => {')) {
    const funcLines = [
      ...
      '        setAlertModal({ show: true, message: \You can submit up to \\\ reviews per day.\\\\nPlease try again tomorrow.\ })',
      '        return false',
      '      }',
      '',
      ...
      '        setAlertModal({ show: true, message: \You can submit up to \\\ reviews per month.\\\\nPlease try again next month.\ })',
      '        return false',
      '      }',
      '',
      ...
      '        setAlertModal({ show: true, message: \You can submit up to \\\ reviews per account.\ })',
      '        return false',
      '      }',
      '',
      '      return true',
    ...
    console.log(\Step 2: Added checkReviewLimits at line \\);
    break;
  }
}
